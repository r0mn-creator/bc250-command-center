...
#
# Vendored, unmodified, from WinnieLV/bc250-cu-live-manager:
#   https://github.com/WinnieLV/bc250-cu-live-manager
# All credit for this tool's design and implementation belongs to that
# project's author. This copy is bundled here purely so the BC-250 Command
# Center is self-contained and doesn't require a separate manual clone.
#
